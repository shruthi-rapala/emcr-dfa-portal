...
public class CommonUtils {
    ...
    static {
        environmentUrls.put(Constants.DEV, "https://portal.dev.dfa.gov.bc.ca/");
        environmentUrls.put(Constants.TST, "https://portal.test.dfa.gov.bc.ca/");
        ...
        environmentUrls.put(Constants.DEV_Public, "https://publicsector-dev.dfa.gov.bc.ca/");
        environmentUrls.put(Constants.TST_Public, "https://publicsector-test.dfa.gov.bc.ca/");
//        environmentUrls.put(Constants.TRN_Public, "https://dfa-public-sector-training.apps.silver.devops.gov.bc.ca/");
        environmentUrls.put(Constants.TRN_Public, "https://publicsector-training.dfa.gov.bc.ca/");
...
//        environmentUrls.put(Constants.TRN_DynamicsPub, "https://embc-dfa2-trn.test.jag.gov.bc.ca/main.aspx?appid=02c4ab7f-accc-ec11-b82a-005056832896&pagetype=dashboard&id=87bd5bc9-6d29-ed11-b834-00505683fbf4&type=system&_canOverride=true");
        ...
        environmentUrls.put(Constants.DEV_SandboxPub, "https://publicsector-dev.dfa.gov.bc.ca/");
        ...
        environmentUrls.put(Constants.TRN_SupportPub, "https://publicsector-training.dfa.gov.bc.ca");
