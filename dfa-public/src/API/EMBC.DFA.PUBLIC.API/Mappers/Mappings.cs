...
namespace EMBC.DFA.API.Mappers
{
    public class Mappings : AutoMapper.Profile
    {
        ...
        public Mappings()
        {
            ...
            CreateMap<DocumentUrl, FileUploadClaimAppeal>()
            ...
            CreateMap<FileUploadProjectAppeal, S3SubmissionEntity>()
                .ForMember(d => d.RegardingEntityID, opts => opts.MapFrom(s => s.appealId))
                .ForMember(d => d.OriginCode, opts => opts.MapFrom(s => ORIGIN_CODE_PORTAL))
                .ForMember(d => d.Metadata_1, opts => opts.MapFrom(s => s.fileTypeText))
                .ForMember(d => d.Metadata_2, opts => opts.MapFrom(s => s.requiredDocumentType))
            ...
            CreateMap<dfa_projectamendment, CurrentProjectAmendment>()
                ...
                .ForMember(d => d.Requested18MonthDate, opts => opts.MapFrom(s => Convert.ToDateTime(s.dfa_requestedamendment18monthdate).Year < 2020 ? string.Empty : Convert.ToDateTime(s.dfa_requestedamendment18monthdate).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)))
            ...
            CreateMap<ProjectAmendment, dfa_projectamendment>()
                ...
                .ForMember(d => d.dfa_requestedamendment18monthdate, opts => opts.MapFrom(s => s.Requested18MonthDate))
            ...
            //CreateMap<ProjectAppeal, dfa_projectappeal>()
                //.ForMember(d => d.dfa_dateappealreceived, opts => opts.MapFrom(s => s.));
                //.ForMember(d => d.X, opts => opts.MapFrom(s => s.))
            ...
            CreateMap<dfa_projectclaim, CurrentClaim>()
                ...
                .ForMember(d => d.SubmittedDate, opts => opts.MapFrom(s => Convert.ToDateTime(s.dfa_claimreceiveddate).Year < 2020 ? "Date Not Set" : Convert.ToDateTime(s.dfa_claimreceiveddate).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)))
                ...
                .ForMember(d => d.ClaimTotal, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.dfa_claimtotal) ? "CA$ 0" : "CA$ " + Convert.ToDecimal(s.dfa_claimtotal).ToString(CurrencyFormat)))
                .ForMember(d => d.ApprovedClaimTotal, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.dfa_totalapproved) || s.dfa_totalapproved == "0" ? "(pending information)" : "CA$ " + Convert.ToDecimal(s.dfa_totalapproved).ToString(CurrencyFormat)))
                .ForMember(d => d.LessFirst1000, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.dfa_onetimedeductionamount) ? "(pending information)" : "CA$ " + Convert.ToDecimal(s.dfa_onetimedeductionamount).ToString(CurrencyFormat)))
                ...
                .ForMember(d => d.EligiblePayable, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.dfa_eligiblepayable) ? "(pending information)" : "CA$ " + Convert.ToDecimal(s.dfa_eligiblepayable).ToString(CurrencyFormat)))
                .ForMember(d => d.PaidClaimAmount, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.dfa_paidclaimamount) ? "(pending information)" : "CA$ " + Convert.ToDecimal(s.dfa_paidclaimamount).ToString(CurrencyFormat)))
                .ForMember(d => d.DateFileClosed, opts => opts.MapFrom(s => s.dfa_bpfclosedate))
                ...
                .ForMember(d => d.LinkedClaim, opts => opts.MapFrom(s => s.dfa_linkedclaim))
            ...
            CreateMap<dfa_claim_retrieve, LinkedClaim>()
                .ForMember(d => d.LinkedClaimId, opts => opts.MapFrom(s => s.dfa_projectclaimid))
                 .ForMember(d => d.LinkedClaimName, opts => opts.MapFrom(s => s.dfa_name));
            ...
            CreateMap<dfa_claim_retrieve, RecoveryClaim>()
                ...
                .ForMember(d => d.claimReceivedDate, opts => opts.MapFrom(s => Convert.ToDateTime(s.dfa_claimreceiveddate).Year < 2020 ? "Date Not Set" : Convert.ToDateTime(s.dfa_claimreceiveddate).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)))
            ...
            CreateMap<DFAProjectMain, dfa_project_params>()
                ...
                .ForMember(d => d.dfa_dateofdamagesameasapplication,
                    opts => opts.MapFrom(s => s.Project.isdamagedDateSameAsApplication))
                .ForMember(d => d.dfa_createdonportal, opts => opts.MapFrom(s => true))
                ...
                .ForMember(d => d.dfa_dateofdamagefrom,
                    opts => opts.MapFrom(s => Convert.ToDateTime(s.Project.sitelocationdamageFromDate)))
                .ForMember(d => d.dfa_dateofdamageto,
                    opts => opts.MapFrom(s => Convert.ToDateTime(s.Project.sitelocationdamageToDate)))
                .ForMember(d => d.dfa_dateofdamagedifferencereason,
                    opts => opts.MapFrom(s => s.Project.differentDamageDatesReason))
                .ForMember(d => d.dfa_sitelocation, opts => opts.MapFrom(s => s.Project.siteLocation))
                .ForMember(d => d.dfa_descriptionofthecauseofdamage,
                    opts => opts.MapFrom(s => s.Project.causeofDamageDetails))
                .ForMember(d => d.dfa_descriptionofdamagedinfrastructure,
                    opts => opts.MapFrom(s => s.Project.infraDamageDetails))
                .ForMember(d => d.dfa_descriptionofdamage, opts => opts.MapFrom(s => s.Project.describeDamageDetails))
                .ForMember(d => d.dfa_descriptionofdamagewithmaterial,
                    opts => opts.MapFrom(s => s.Project.describeDamagedInfrastructure))
                .ForMember(d => d.dfa_descriptionofrepairwork, opts => opts.MapFrom(s => s.Project.repairWorkDetails))
                .ForMember(d => d.dfa_descriptionofmaterialneededtorepair,
                    opts => opts.MapFrom(s => s.Project.repairDamagedInfrastructure))
                .ForMember(d => d.dfa_estimatedcompletiondateofproject,
                    opts => opts.MapFrom(s => Convert.ToDateTime(s.Project.estimatedCompletionDate)))
                .ForMember(d => d.dfa_estimatedcost,
                    opts => opts.MapFrom(s => s.Project != null ? s.Project.estimateCostIncludingTax : (decimal?)null))
                .ForMember(d => d.dfa_projecttype,
                    opts => opts.MapFrom(s =>
                        s.Project.projectType != null
                            ? (s.Project.projectType == "Infrastructure Repair"
                                ? Convert.ToInt32(ProjectTypes.InfrastructureRepair)
                                : (s.Project.projectType == "Debris Cleanup"
                                    ? Convert.ToInt32(ProjectTypes.DebrisCleanup)
                                    : (s.Project.projectType == "Engineering"
                                        ? Convert.ToInt32(ProjectTypes.Engineering)
                                        : (s.Project.projectType == "Planning & Design"
                                            ? Convert.ToInt32(ProjectTypes.PlanningDesign)
            ...
            CreateMap<DFAClaimMain, dfa_claim_params>()
                ...
                .ForMember(d => d.dfa_claimreceiveddate, opts => opts.MapFrom(s => s.Claim.claimStatus != null && s.Claim.claimStatus.Value == ClaimStageOptionSet.SUBMIT ? DateTime.Now : (DateTime?)null))
            ...
            CreateMap<dfa_recoveryinvoice, CurrentInvoice>()
                ...
                .ForMember(d => d.NetInvoiceBeingClaimed, opts => opts.MapFrom(s => s.dfa_netinvoicedbeingclaimed.HasValue ? decimal.Round(decimal.Parse(s.dfa_netinvoicedbeingclaimed.Value.ToString("0.00")), 2) : (decimal?)null))
                .ForMember(d => d.PST, opts => opts.MapFrom(s => s.dfa_pst.HasValue ? decimal.Round(decimal.Parse(s.dfa_pst.Value.ToString("0.00")), 2) : (decimal?)null))
                .ForMember(d => d.GrossGST, opts => opts.MapFrom(s => s.dfa_grossgst.HasValue ? decimal.Round(decimal.Parse(s.dfa_grossgst.Value.ToString("0.00")), 2) : (decimal?)null))
                ...
                .ForMember(d => d.EligibleGST, opts => opts.MapFrom(s => s.dfa_eligiblegst.HasValue ? decimal.Round(decimal.Parse(s.dfa_eligiblegst.Value.ToString("0.00")), 2) : (decimal?)null))
                .ForMember(d => d.ActualInvoiceTotal, opts => opts.MapFrom(s => s.dfa_actualinvoicetotal.HasValue ? decimal.Round(decimal.Parse(s.dfa_actualinvoicetotal.Value.ToString("0.00")), 2) : (decimal?)null))
                .ForMember(d => d.TotalBeingClaimed, opts => opts.MapFrom(s => s.dfa_totalbeingclaimed.HasValue ? decimal.Round(decimal.Parse(s.dfa_totalbeingclaimed.Value.ToString("0.00")), 2) : (decimal?)null))
            ...
            CreateMap<dfa_projectmain_retrieve, RecoveryPlan>()
                ...
                .ForMember(d => d.approvedCost, opts => opts.MapFrom(s => s.dfa_approvedcost.HasValue ? decimal.Round(decimal.Parse(s.dfa_approvedcost.Value.ToString("F")), 2) : (decimal)0))
                .ForMember(d => d.approvedAmendedProjectCost, opts => opts.MapFrom(s => s.dfa_approvedamendedprojectcost.HasValue ? decimal.Round(decimal.Parse(s.dfa_approvedamendedprojectcost.Value.ToString("F")), 2) : (decimal)0))
