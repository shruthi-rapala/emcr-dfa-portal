            ...
            try
            {
                    ...
                    Select = new[]
                        {
                            ...
                            "dfa_requestedamendment18monthdate",
                ...
                var lstPrjAmnds = (from objApp in lstAmendment.List
                               select new dfa_projectamendment
                               {
                                   ...
                                   dfa_requestedamendment18monthdate = !string.IsNullOrEmpty(objApp.dfa_requestedamendment18monthdate) ? DateTime.Parse(objApp.dfa_requestedamendment18monthdate).ToLocalTime().ToString() : objApp.dfa_requestedamendment18monthdate,
            ...
            try
            {
                ...
                var lstApps = (from objApp in list.List
                               select new dfa_claim_retrieve
                               {
                                   ...
                                   dfa_claimtype = objApp.dfa_claimtype,
