...
using System.Linq;
using EMBC.DFA.API.Extensions;
using Google.Protobuf;
using Microsoft.Extensions.Logging;

namespace EMBC.DFA.API.Extensions
{
    /// <summary>
    ...
    public static partial class FileManager
    {
        ...
        {
            var fileSystemItemVMList = new List<Public.ViewModels.FileSystemItem>();
            ...
            try
            {
                ...
                if (result.ResultStatus == ResultStatus.Success)
                {
                    ...
                    {
                        var fileSystemItemVM = new Public.ViewModels.FileSystemItem
                        {
