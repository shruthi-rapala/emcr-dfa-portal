...
export function configurationGetSecurityQuestions(http: HttpClient, rootUrl: string, params?: ConfigurationGetSecurityQuestions$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<string>>> {
