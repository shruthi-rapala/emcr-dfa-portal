...
export function configurationGetCodes(http: HttpClient, rootUrl: string, params?: ConfigurationGetCodes$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Code>>> {
