...
export function configurationGetCountries(http: HttpClient, rootUrl: string, params?: ConfigurationGetCountries$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Code>>> {
