...
export function configurationGetStateProvinces(http: HttpClient, rootUrl: string, params?: ConfigurationGetStateProvinces$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Code>>> {
