...
export function configurationGetOutageInfo(http: HttpClient, rootUrl: string, params?: ConfigurationGetOutageInfo$Params, context?: HttpContext): Observable<StrictHttpResponse<OutageInformation>> {
