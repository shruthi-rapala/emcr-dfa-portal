    ...
    public class Mappings : AutoMapper.Profile
    {
        public Mappings()
        {
            CreateMap<Profile, dfa_appcontact>()
                ...
                .ForMember(d => d.dfa_isindigenous, opts => opts.MapFrom(s => s.PersonalDetails.IndigenousStatus))
                ...
                .ForMember(d => d.dfa_currentaddressline1, opts => opts.MapFrom(s => s.MailingAddress.AddressLine1))
                .ForMember(d => d.dfa_currentaddressline2, opts => opts.MapFrom(s => s.MailingAddress.AddressLine2))
                .ForMember(d => d.dfa_currentcity, opts => opts.MapFrom(s => s.MailingAddress.City))
                .ForMember(d => d.dfa_currentpostalcode, opts => opts.MapFrom(s => s.MailingAddress.PostalCode))
