    ...
    public class Mappings : AutoMapper.Profile
    {
        public Mappings()
        {
            ...
            CreateMap<DFAApplicationStart, dfa_appapplicationstart>()
                ...
                .ForMember(d => d.dfa_primaryapplicationsignednoins, opts => opts.MapFrom(s => s.AppTypeInsurance.applicantSignature != null ? YesNoOptionSet.Yes : YesNoOptionSet.No))
                .ForMember(d => d.dfa_primaryapplicantprintnamenoins, opts => opts.MapFrom(s => s.AppTypeInsurance.applicantSignature.signedName))
                .ForMember(d => d.dfa_primaryapplicationsigneddatenoins, opts => opts.MapFrom(s => s.AppTypeInsurance.applicantSignature.dateSigned))
            ...
            CreateMap<dfa_appapplicationstart, AppTypeInsurance>()
                ...
                .ForPath(d => d.applicantSignature.dateSigned, opts => opts.MapFrom(s => s.dfa_primaryapplicationsigneddatenoins))
