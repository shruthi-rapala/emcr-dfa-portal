    ...
    public class Mappings : AutoMapper.Profile
    {
        public Mappings()
        {
            ...
            CreateMap<DFAApplicationMain, dfa_appapplicationmain_params>()
                ...
                .ForMember(d => d.dfa_causeofdamagewildfire, opts => opts.MapFrom(s => s.propertyDamage.wildfireDamage))
                .ForMember(d => d.dfa_causeofdamagestorm, opts => opts.MapFrom(s => s.propertyDamage.stormDamage))
                .ForMember(d => d.dfa_causeofdamageflood, opts => opts.MapFrom(s => s.propertyDamage.floodDamage))
                .ForMember(d => d.dfa_causeofdamagelandslide, opts => opts.MapFrom(s => s.propertyDamage.landslideDamage))
                .ForMember(d => d.dfa_causeofdamageother, opts => opts.MapFrom(s => s.propertyDamage.otherDamage))
                ...
                .ForMember(d => d.dfa_havereceiptsforcleanupsorrepairs, opts => opts.MapFrom(s => s.cleanUpLog.haveInvoicesOrReceiptsForCleanupOrRepairs))
                .ForMember(d => d.dfa_acopyofarentalagreementorlease, opts => opts.MapFrom(s => s.supportingDocuments.hasCopyOfARentalAgreementOrLease))
