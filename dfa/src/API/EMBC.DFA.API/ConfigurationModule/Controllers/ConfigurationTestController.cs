...
namespace EMBC.DFA.API.ConfigurationModule.Controllers
{
    ///// <summary>
    ...
    //    public ConfigurationTestController(IConfiguration configuration, IMessagingClient client, IMapper mapper, ICache cache, IHostEnvironment environment)
    //    {
    ...
    //                Scope = oidcConfig.GetValue("scope", "openid offline_access dfa-portal"),
    //                Idp = oidcConfig.GetValue("idp", "bcsc")
    //            },
    //            OutageInfo = mapper.Map<OutageInformation>(outageInfo),
    //            TimeoutInfo = new TimeoutConfiguration
    //            {
    //                SessionTimeoutInMinutes = configuration.GetValue("timeout:minutes", 20),
    //                WarningMessageDuration = configuration.GetValue("timeout:warningDuration", 1)
    //            },
