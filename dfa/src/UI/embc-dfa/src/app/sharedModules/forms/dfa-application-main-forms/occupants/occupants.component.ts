    ...
    this.dfaApplicationMainDataService
      ...
      .subscribe({
        ...
        error: (err) => {
          ...
          this._snackBar.open(
            'Unable to deleteDocumentSummaryRow. Please retry the upload process.',
            'Close',
            {
  ...
  getSecondaryApplicantsForApplication(applicationId: string) {
    ...
    this.secondaryApplicantsService.secondaryApplicantGetSecondaryApplicants({ applicationId: applicationId }).subscribe({
      ...
      error: (error) => {
        ...
        // document.location.href = 'https://dfa.gov.bc.ca/error.html';
        this._snackBar.open(
          'Unable to load secondary applicants. Please try again later.',
          'Close',
          {
            horizontalPosition: 'center',
            verticalPosition: 'top',
    ...
    this.otherContactsService.otherContactGetOtherContacts({ applicationId: applicationId })
      .subscribe({
        ...
        error: (error) => {
          ...
          // document.location.href = 'https://dfa.gov.bc.ca/error.html';
          this._snackBar.open(
            'Unable to load other contacts. Please try again later.',
            'Close',
            {
              horizontalPosition: 'center',
              verticalPosition: 'top',
    ...
    this.fullTimeOccupantsService.fullTimeOccupantGetFullTimeOccupants({ applicationId: applicationId })
      .subscribe({
        ...
        error: (error) => {
          ...
          // document.location.href = 'https://dfa.gov.bc.ca/error.html';
          this._snackBar.open(
            'Unable to load full-time occupants. Please try again later.',
            'Close',
            {
              horizontalPosition: 'center',
              verticalPosition: 'top',
