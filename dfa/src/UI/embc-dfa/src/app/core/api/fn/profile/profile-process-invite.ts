...
export function profileProcessInvite(http: HttpClient, rootUrl: string, params: ProfileProcessInvite$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
