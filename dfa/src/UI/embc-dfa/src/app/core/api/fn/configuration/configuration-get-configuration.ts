...
export function configurationGetConfiguration(http: HttpClient, rootUrl: string, params?: ConfigurationGetConfiguration$Params, context?: HttpContext): Observable<StrictHttpResponse<Configuration>> {
