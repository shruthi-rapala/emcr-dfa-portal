...
export function profileGetDoesUserExists(http: HttpClient, rootUrl: string, params?: ProfileGetDoesUserExists$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
