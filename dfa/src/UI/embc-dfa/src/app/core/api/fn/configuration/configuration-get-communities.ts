...
export function configurationGetCommunities(http: HttpClient, rootUrl: string, params?: ConfigurationGetCommunities$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CommunityCode>>> {
