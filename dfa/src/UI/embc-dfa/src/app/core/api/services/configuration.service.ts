...
import { configurationGetAreaCommunities } from '../fn/configuration/configuration-get-area-communities';
import { ConfigurationGetAreaCommunities$Params } from '../fn/configuration/configuration-get-area-communities';
...
export class ConfigurationService extends BaseService {
   ...
   */
  configurationGetConfiguration$Response(params?: ConfigurationGetConfiguration$Params, context?: HttpContext): Observable<StrictHttpResponse<Configuration>> {
   ...
   * This method doesn't expect any request body.
   */
  configurationGetConfiguration(params?: ConfigurationGetConfiguration$Params, context?: HttpContext): Observable<Configuration> {
   ...
   * This method doesn't expect any request body.
   */
  configurationGetCodes$Response(params?: ConfigurationGetCodes$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Code>>> {
   ...
   * This method doesn't expect any request body.
   */
  configurationGetCountries$Response(params?: ConfigurationGetCountries$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Code>>> {
   ...
   * This method doesn't expect any request body.
   */
  configurationGetAreaCommunities$Response(params?: ConfigurationGetAreaCommunities$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<AreaCommunity>>> {
    return configurationGetAreaCommunities(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  configurationGetAreaCommunities(params?: ConfigurationGetAreaCommunities$Params, context?: HttpContext): Observable<Array<AreaCommunity>> {
    return this.configurationGetAreaCommunities$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<AreaCommunity>>): Array<AreaCommunity> => r.body)
    );
  }
