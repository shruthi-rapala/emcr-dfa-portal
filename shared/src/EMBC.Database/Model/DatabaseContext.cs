...
namespace EMBC.Database.Model
{
	...
	public partial class DatabaseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		public System.Linq.IQueryable<EMBC.Database.Model.DFA_Appeal> DFA_AppealSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.DFA_Appeal>();
			}
		}
		...
		public System.Linq.IQueryable<EMBC.Database.Model.DFA_ClientCode> DFA_ClientCodeSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.DFA_ClientCode>();
			}
		}
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="EMBC.Database.Model.EMCR_ExpenseProject"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EMBC.Database.Model.EMCR_ExpenseProject> EMCR_ExpenseProjectSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.EMCR_ExpenseProject>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="EMBC.Database.Model.EMCR_ResponsibilityCentre"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EMBC.Database.Model.EMCR_ResponsibilityCentre> EMCR_ResponsibilityCentreSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.EMCR_ResponsibilityCentre>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="EMBC.Database.Model.EMCR_ServiceLine"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EMBC.Database.Model.EMCR_ServiceLine> EMCR_ServiceLineSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.EMCR_ServiceLine>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="EMBC.Database.Model.EMCR_Stob"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EMBC.Database.Model.EMCR_Stob> EMCR_StobSet
		{
			get
			{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="EMBC.Database.Model.SystemUser"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EMBC.Database.Model.SystemUser> SystemUserSet
		{
			get
			{
				return this.CreateQuery<EMBC.Database.Model.SystemUser>();
			}
		}
	}
