...
namespace EMBC.Database.Model
{
	...
	public partial class DatabaseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.DFA_ClientCode"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.DFA_ClientCode> DFA_ClientCodeSet
		{
			get
			{
				return this.CreateQuery<Database.Model.DFA_ClientCode>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.DFA_ProjectClaim"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.DFA_ProjectClaim> DFA_ProjectClaimSet
		{
			get
			{
				return this.CreateQuery<Database.Model.DFA_ProjectClaim>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.EMCR_ExpenseProject"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.EMCR_ExpenseProject> EMCR_ExpenseProjectSet
		{
			get
			{
				return this.CreateQuery<Database.Model.EMCR_ExpenseProject>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.EMCR_ResponsibilityCentre"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.EMCR_ResponsibilityCentre> EMCR_ResponsibilityCentreSet
		{
			get
			{
				return this.CreateQuery<Database.Model.EMCR_ResponsibilityCentre>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.EMCR_ServiceLine"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.EMCR_ServiceLine> EMCR_ServiceLineSet
		{
			get
			{
				return this.CreateQuery<Database.Model.EMCR_ServiceLine>();
			}
		}
