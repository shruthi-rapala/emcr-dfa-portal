    ...
    public class ProjectAmendmentMapper : Profile
    {
        public ProjectAmendmentMapper()
        {
            ...
            CreateMap<ProjectAmendment, DFA_ProjectAmendment>()
                ...
                .ForMember(d => d.DFA_RequestForProjectDeadlineExtension, opts => opts.MapFrom(s => s.RequestforProjectDeadlineExtention == "Yes" ? true : false))
                .ForMember(d => d.DFA_DeadlineExtensionApprovedName, opts => opts.MapFrom(s => s.DeadlineExtensionApproved))
                .ForMember(d => d.DFA_RequestForAdditionalProjectCost, opts => opts.MapFrom(s => s.RequestforAdditionalProjectCost == "Yes" ? true : false))
