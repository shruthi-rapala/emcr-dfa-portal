...
public class AppealMapper : Profile
{
    public AppealMapper()
    {
        CreateMap<DFA_Appeal, Appeal>()
            ...
            .ForMember(dest => dest.ReviewedEvaluatorReport, opt => opt.MapFrom(src => src.DFA_ReviewedEvaluatorReport.HasValue ? src.DFA_ReviewedEvaluatorReport.Value : false))
        ...
        CreateMap<Appeal, DFA_Appeal>()
            ...
            .ForMember(dest => dest.DFA_ReviewedEvaluatorReport, opt => opt.MapFrom(src => src.ReviewedEvaluatorReport.HasValue ? src.ReviewedEvaluatorReport.Value : false))
        ...
        CreateMap<CaseEligibilityAppealComposite, Appeal>()
            ...
            .ForMember(dest => dest.AppealDecision, opt => opt.MapFrom(src => (PrivateAppealDecision?)src.caseAppeal.DFA_AMnTAppeal_AppealDecision))
