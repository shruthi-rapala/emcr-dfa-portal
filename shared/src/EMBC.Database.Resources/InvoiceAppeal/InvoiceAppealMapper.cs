    ...
    public class InvoiceAppealMapper: Profile
    {
        public InvoiceAppealMapper()
        {
            CreateMap<DFA_InvoiceAppeal, InvoiceAppeal>()
                ...
                .ForMember(dest => dest.InvoiceDecisionComments, opts => opts.MapFrom(src => src.DFA_DecisionComments));
            ...
            CreateMap<InvoiceAppeal, DFA_InvoiceAppeal>()
                ...
                .ForMember(dest => dest.DFA_DecisionComments, opt => opt.MapFrom(src => src.InvoiceDecisionComments));
        }
    }
}
